...
$businessname= $_SESSION['displayBusinessName'];
$address= $_SESSION['displayAddress'];
?>
...
<div class="offcanvas offcanvas-start" id="demo">
  ...
  <div class="offcanvas-body">
    <p><a href="Our_products.html" class="link-dark">See my product</a></p>
    <p><a href="add_product.html" class="link-dark">Add product</a></p>
            ...
            <div class="col-8"> 
                ...
                <div class="upload-profile-image d-flex justify-content-center pb-5">
                    <div class="text-center">
                        <img src="./assets/profile/beard.png" style="width: 200px; height: 200px" class="img rounded" alt="profile">
            ...
            <div class="col-2">
                <div class="d-flex justify-content-center">
                    <div class="reg-form">
                        <div class="form-row">
                            <div class="col">
                                <div>Business Name:  <?php echo $businessname ?> </div>
                            </div>
                        </div>
                        ...
                        <div class="form-row my-4">
                            <div class="col">
                                <div>Business Address:  <?php echo $address ?> </div>
                            </div>
                        </div>
                    </div>
